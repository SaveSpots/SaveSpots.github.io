...
export function StopHiringSection() {
    ...
    <AnimatedSection className="py-20 px-4 bg-theme-red-light">
      <div className="max-w-6xl mx-auto text-center">
        ...
        >
          ...
          senior-level development firm that builds robust, enterprise-grade AI
          systems to automate your operations, increase your revenue, and secure
          your market share.
        </motion.p>
        <motion.div
          variants={fadeInUp}
